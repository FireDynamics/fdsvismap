...
class MapStyle:
    ...
    :param not_visible: Color of cells from which no waypoint is visible.
    :type not_visible: str
    :param visible: Color of cells from which a waypoint is visible.
    :type visible: str
    :param sign: Color of the waypoints, drawn as a short bar across the viewing direction with an arrow in the
    ...
    :type aset_cmap: str
    :param never_visible: Color of cells in the ASET map from which no waypoint is visible at any time point. The
